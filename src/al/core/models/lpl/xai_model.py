...
from al.core.models.lpl.base_module import LPLBaseModule
...
class LPLXAIModel(XAIModel):
    def __init__(
        ...
        # wrap the model with LPL model
        self._torch_model = LPLBaseModule(args, tb_logger, self._torch_model)
