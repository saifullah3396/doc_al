...
from al.core.models.vaal.base_module import VAALBaseModule
...
class VAALXAIModel(XAIModel):
    def __init__(
        ...
        # wrap the model with Vaal model
        self._torch_model = VAALBaseModule(args, tb_logger, self._torch_model)

        # build model
        self._torch_model._build_model()

        # initialize metrics
        self._torch_model._init_metrics()
