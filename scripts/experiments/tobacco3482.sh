...
BASE_EXP_CONFIG="$TRAIN_SCRIPT --config-path ../../../cfg/al_adv/ +experiment=active_learning/tobacco3482/resnet50"
BASE_EXP_CONFIG_IMB="$TRAIN_SCRIPT --config-path ../../../cfg/al_adv/ +experiment=active_learning/tobacco3482/resnet50_imb"
BASE_EXP_CONFIG_N10="$TRAIN_SCRIPT --config-path ../../../cfg/al_adv/ +experiment=active_learning/tobacco3482/resnet50_noisy_10"
BASE_EXP_CONFIG_N20="$TRAIN_SCRIPT --config-path ../../../cfg/al_adv/ +experiment=active_learning/tobacco3482/resnet50_noisy_20"
...
{
    echo "Usage:"
    echo "./sbatch_run.sh --query=<query-strategy> --exp=<experiment-type> --data-path=</path/to/dataset> --seed=<seed>"
    echo ""
