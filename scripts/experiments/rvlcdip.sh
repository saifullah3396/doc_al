...
BASE_EXP_CONFIG="$TRAIN_SCRIPT --config-path ../../../cfg/al_adv/ +experiment=active_learning/rvlcdip/resnet50"
BASE_EXP_CONFIG_IMB="$TRAIN_SCRIPT --config-path ../../../cfg/al_adv/ +experiment=active_learning/rvlcdip/resnet50_imb"
BASE_EXP_CONFIG_N10="$TRAIN_SCRIPT --config-path ../../../cfg/al_adv/ +experiment=active_learning/rvlcdip/resnet50_noisy_10"
BASE_EXP_CONFIG_N20="$TRAIN_SCRIPT --config-path ../../../cfg/al_adv/ +experiment=active_learning/rvlcdip/resnet50_noisy_20"
