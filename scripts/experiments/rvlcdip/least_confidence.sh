...
CONFIGS=(
    # "rvlcdip_resnet50_least_confidence_4k $BASE_EXP_CONFIG_RVLCDIP args/al_args=least_confidence args.al_args.n_query_ratio=0.0125 args.al_args.n_rounds=25 args.training_args.experiment_name=least_confidence_4k" # 0
    # "rvlcdip_resnet50_least_confidence_8k $BASE_EXP_CONFIG_RVLCDIP args/al_args=least_confidence args.al_args.n_query_ratio=0.025 args.al_args.n_rounds=13 args.training_args.experiment_name=least_confidence_8k" # 1
    # "rvlcdip_resnet50_least_confidence_16k $BASE_EXP_CONFIG_RVLCDIP args/al_args=least_confidence args.al_args.n_query_ratio=0.05 args.al_args.n_rounds=7 args.training_args.experiment_name=least_confidence_16k" # 2
