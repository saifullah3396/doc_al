...
CONFIGS=(
    # "rvlcdip_resnet50_margin_sampling_dropout_4k $BASE_EXP_CONFIG_RVLCDIP args/al_args=margin_sampling_dropout args.al_args.n_query_ratio=0.0125 args.al_args.n_rounds=25 args.training_args.experiment_name=margin_sampling_dropout_4k" # 0
    # "rvlcdip_resnet50_margin_sampling_dropout_8k $BASE_EXP_CONFIG_RVLCDIP args/al_args=margin_sampling_dropout args.al_args.n_query_ratio=0.025 args.al_args.n_rounds=13 args.training_args.experiment_name=margin_sampling_dropout_8k" # 1
    # "rvlcdip_resnet50_margin_sampling_dropout_16k $BASE_EXP_CONFIG_RVLCDIP args/al_args=margin_sampling_dropout args.al_args.n_query_ratio=0.05 args.al_args.n_rounds=7 args.training_args.experiment_name=margin_sampling_dropout_16k" # 2
